Each folder includes results of fine-tuning our classifier on data from certain contexts. Folder names specifying which contexts were used for training. 
